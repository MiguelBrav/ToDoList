...
{
    public class InstructionCommandHandler : IRequestHandler<InstructionCommand, ApiResponse>
    {
        private readonly IInstructionsTranslatedService _instructionsTranslatedService;

        public InstructionCommandHandler(IInstructionsTranslatedService instructionsTranslatedService)
        {
            _instructionsTranslatedService = instructionsTranslatedService;
        }

        public async Task<ApiResponse> Handle(InstructionCommand request, CancellationToken cancellationToken)
        {
