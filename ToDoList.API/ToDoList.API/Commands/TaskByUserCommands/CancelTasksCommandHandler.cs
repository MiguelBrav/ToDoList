...
{
    public class CancelTasksCommandHandler : UseCaseBase<CancelTasksCommand, ApiResponse>
    {
        ...
        public override async Task<ApiResponse> Execute(CancelTasksCommand request)
        {
