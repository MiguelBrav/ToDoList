...
namespace ToDoList.API.Commands.TaskByUserBinCommands
{
    public class CleansAllTasksCommandHandler : UseCaseBase<CleansAllTasksCommand, ApiResponse>
    {
        ...
        public CleansAllTasksCommandHandler(UserManager<IdentityUser> userManager, IUsersAppService usersAppService, ITaskUserService taskUserService,ITaskUserHistoricalService taskHistoricalUserService)
        {
        ...
        public override async Task<ApiResponse> Execute(CleansAllTasksCommand request)
        {
            ...
            List<TaskByUser> taskToDeleted = await _taskUserService.GetAllTasksBinByUserId(request.UserId);
