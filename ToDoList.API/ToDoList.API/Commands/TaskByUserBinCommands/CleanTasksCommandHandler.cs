...
{
    public class CleanTasksCommandHandler : IRequestHandler<CleanTasksCommand, ApiResponse>
    {
        ...
        public async Task<ApiResponse> Handle(CleanTasksCommand request, CancellationToken cancellationToken)
        {
